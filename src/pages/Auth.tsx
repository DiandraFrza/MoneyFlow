  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark flex flex-col items-center justify-center p-4 transition-colors duration-200">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div className="h-12 w-12 rounded-2xl bg-primary flex items-center justify-center text-white shadow-lg font-black text-2xl animate-pulse">
          M
        </div>
        <div>
        ...
        <Card className="glass-card">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              {mode === 'login' && (
                <button
                  ...
                  className="text-xs text-right text-primary font-bold hover:underline self-end"
                >
                  Lupa password?
                </button>
              )}
            ...
            <div className="relative flex py-5 items-center">
              ...
              <span className="flex-shrink mx-4 text-text-mutedLight dark:text-text-mutedDark text-[10px] font-bold uppercase tracking-wider">Atau</span>
              <div className="flex-grow border-t border-slate-200 dark:border-slate-800"></div>
            </div>
            ...
            <Button
              ...
              className="w-full h-11 border-dashed font-bold text-sm text-slate-700 dark:text-slate-200"
            >
